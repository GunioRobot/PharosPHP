<script type="text/javascript">
	...
	$(function() {
		...
		$('#dashboard-tabs a').click(function(e) {
			...
			// Load in the data
			$("#dashboard-top10").load("<?=controller_link('Dashboard','content/')?>"+this.id, '', setup_dropdowns);
	...
	function register_dropdown() {
		...
		$('#dashboard-top10')
			.load("<?=controller_link('Dashboard','content')?>/"+table+"/"+$('#content_types').val()+"/"+$('#paginate').val(), '', setup_dropdowns);
	}
