<?
	...
	if ( $form_array['default'] && !$value ) {
		...
		$item = '<input id="'.$id.'" type="text" name="'.$form_array['name'].'" value="'.$value.'" size="'.$form_array['size'].'" maxlength="'.$form_array['max'].'" class="'.$form_array['class'].'" style="'.$form_array['style'].'">';
	}
