...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `text` text NOT NULL,
  `template` varchar(50) NOT NULL default 'oneCol',
  `image1` text NOT NULL,
  `image1_thumb` text NOT NULL,
  `image1_alt` text NOT NULL,
  `image1_file_size` bigint(20) NOT NULL default '0',
  `image2` text NOT NULL,
  `image2_thumb` text NOT NULL,
  `image2_alt` text NOT NULL,
  `image3` text NOT NULL,
  `image3_thumb` text NOT NULL,
  `image3_alt` text NOT NULL,
  `image4` text NOT NULL,
  `image4_thumb` text NOT NULL,
  `image4_alt` text NOT NULL,
  `image5` text NOT NULL,
  `image5_thumb` text NOT NULL,
  `image5_alt` text NOT NULL,
  `image6` text NOT NULL,
  `image6_thumb` text NOT NULL,
  `image6_alt` text NOT NULL,
  `image7` text NOT NULL,
  `image7_thumb` text NOT NULL,
  `image7_alt` text NOT NULL,
  `image8` text NOT NULL,
  `image8_thumb` text NOT NULL,
  `image8_alt` text NOT NULL,
  `document_1` text NOT NULL,
  `document_1_title` text NOT NULL,
  `document_2` text NOT NULL,
  `document_2_title` text NOT NULL,
  `document_3` text NOT NULL,
  `document_3_title` text NOT NULL,
  `document_4` text NOT NULL,
  `document_4_title` text NOT NULL,
  `document_5` text NOT NULL,
  `document_5_title` text NOT NULL,
  `document_6` text NOT NULL,
  `document_6_title` text NOT NULL,
  `document_7` text NOT NULL,
  `document_7_title` text NOT NULL,
  `document_8` text NOT NULL,
  `document_8_title` text NOT NULL,
  `document_9` text NOT NULL,
  `document_9_title` text NOT NULL,
  `document_10` text NOT NULL,
  `document_10_title` text NOT NULL,
  `document_11` text NOT NULL,
  `document_11_title` text NOT NULL,
  `document_12` text NOT NULL,
  `document_12_title` text NOT NULL,
  `document_13` text NOT NULL,
  `document_13_title` text NOT NULL,
  `document_14` text NOT NULL,
  `document_14_title` text NOT NULL,
  `document_15` text NOT NULL,
  `document_15_title` text NOT NULL,
  `document_16` text NOT NULL,
  `document_16_title` text NOT NULL,
  `document_17` text NOT NULL,
  `document_17_title` text NOT NULL,
  `document_18` text NOT NULL,
  `document_18_title` text NOT NULL,
  `document_19` text NOT NULL,
  `document_19_title` text NOT NULL,
  `document_20` text NOT NULL,
  `document_20_title` text NOT NULL,
  `document_21` text NOT NULL,
  `document_21_title` text NOT NULL,
  `document_22` text NOT NULL,
  `document_22_title` text NOT NULL,
  `document_23` text NOT NULL,
  `document_23_title` text NOT NULL,
  `document_24` text NOT NULL,
  `document_24_title` text NOT NULL,
  `document_25` text NOT NULL,
  `document_25_title` text NOT NULL,
  `document_26` text NOT NULL,
  `document_26_title` text NOT NULL,
  `document_27` text NOT NULL,
  `document_27_title` text NOT NULL,
  `document_28` text NOT NULL,
  `document_28_title` text NOT NULL,
  `document_29` text NOT NULL,
  `document_29_title` text NOT NULL,
  `document_30` text NOT NULL,
  `document_30_title` text NOT NULL,
  `notes` text NOT NULL,
  `date_added` datetime NOT NULL default '0000-00-00 00:00:00',
  `last_updated` datetime NOT NULL default '0000-00-00 00:00:00',
  PRIMARY KEY  (`id`)
